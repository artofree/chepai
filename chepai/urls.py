...
urlpatterns = [
    ...
    url(r'^drill$', 'polls.views.drill', name='drill'),
    url(r'^getDrillInfo$', 'polls.views.getDrillInfo', name='getDrillInfo'),
    ...
    url(r'^getStatus$', 'polls.views.getStatus', name='getStatus'),
    ...
    url(r'^getTrueCode$', 'polls.views.getTrueCode', name='getTrueCode'),
