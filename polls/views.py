...
priceStage=['33-40.0-400',                     #0
            ...
            '45-55.0-900',                     #2----(22-4)(2-1-1)
            '45-54.5-1000',                    #3----(20-0,24-0)(5-2-1,27-2-1)
            '45-55.0-1000',                    #4----(8-0,1-4)(28-1-1)
            '45-55.5-1000',                    #5----(3-0,16-0,15-4)(10-1-1,6-1-1,9-3-1)
            '45-56.0-1000',                    #6----(7-0,17-0,30-4)(4-3-1,19-3-1)
            '48-55.0-900',                     #7----(18-11-3:1)
            '48-55.5-900',                     #8----(11-11-3:2)
            '48-55.5-1000',                    #9----(29-12-3:5)
            '48-56.0-1000',                    #10---(14-12-3:6)
            '49-56.5-400',                     #11---(12-0)(23-5-2)
            '49-56.5-500',                     #12---(25-0)(13-6-2)
            '47-56.0-400']                     #       捉崩盘价
