...
priceStage=['33-39.0-400',                    #0
            '42-55.0-1000',                   #1------()
            '42-55.5-1000',                   #2------(0-11，1-8)
            '42-56.0-1000',                   #3------(1-1,3-13)
            '45-54.0-1000',                   #4------()
            '45-54.5-1000',                   #5------()如果人数接近27，则0挪至此
            '45-55.0-1000',                   #6------(0-9,1-2,3-4)
            '46-55.0-800',                    #7------(1-12)
            '46-56.0-800',                    #8------(0-14)
            '46-54.5-900',                    #9------()
            '46-55.0-900',                    #10-----(2-6,3-7)
            '46-55.5-900',                    #11-----(0-5,1-10,1-3)
            '46-55.0-1000',                   #12-----()
            '42-54.0-500']                    #11       捉妖月价
