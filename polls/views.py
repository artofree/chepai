...
priceStage=['33-39.0-400',                    #0
            '42-55.0-1000',                   #1------(1-17)
            '42-55.5-1000',                   #2------(0-5)
            '42-56.0-1000',                   #3------
            '45-54.0-1000',                   #4------
            '45-54.5-1000',                   #5------(1-3 ,0-6 ,0-8 ,0-1)
            '45-55.0-1000',                   #6------(1-18 ,0-15)
            '46-55.0-800',                    #7------(1-2 ,2-13)
            '46-55.5-800',                    #8------(1-16 ,2-10 ,0-14)如果人数大于26，0挪到900或者1000
            '46-54.5-900',                    #9------(1-9 ,2-11 ,0-7)
            '46-55.0-900',                    #10-----(1-19 ,3-12 ,0-4)
            '42-54.0-500']                    #11       捉妖月价
