...
priceStage=['33-40.0-400',                     #0
            #参考7、8(57/58)
            '45-55.3-900',                     #1!---(-0)(-0)(-1-1)
            '45-55.5-900',                     #2----(-0)(-1-1)
            #参考7、8(58/59)
            '45-55.5-1000',                    #3!---(-0)(-0)(-1-3)
            '45-55.7-1000',                    #4!---(-0)(-0)(-1-3)
            #策略3
            '48-55.5-1000',                    #5----(-10-3-0::3)
            '48-55.7-1000',                    #6----(-11-3-0::4)
            #参考6(58/59)
            '48-56.7-700',                     #7!---(-0)(-0)(-0)(-0)(-0)(-1-2:0)
            '48-57.0-700',                     #8!---(-0)(-0)(-0)(-0)(-0)(-2-2:0)
            '48-57.2-700',                     #9!---(-0)(-1-2:1)(-4-2:3)
            #参考9(58/59)
            '49-57.3-500',                     #10---(-0)(-0)
            '49-57.5-500',                     #11---(-0)(-0)
            '49-56.5-400']                     #
