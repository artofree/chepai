...
priceStage=['33-40.0-400',                     #0
            '45-54.5-900',                     #1----(26-0)(21-2-1)
            '45-55.0-900',                     #2----(27-0)(2-1-1)
            '45-54.5-1000',                    #3----(20-0,24-0)(5-2-1,29-2-1)
            '45-55.0-1000',                    #4----(25-0,8-0,1-4)(28-1-1,7-2-1)
            '45-55.5-1000',                    #5----(3-0,16-0,15-4)(17-1-1,6-1-1,9-3-1)
            '45-56.0-1000',                    #6----(14-0,22-4)(4-3-1,19-3-1)
            '48-54.8-900',                     #7----(18-11-3:2)
            '48-55.2-900',                     #8----(11-11-3:2)
            '48-55.4-1000',                    #9----(10-12-3:5)
            '48-55.8-1000',                    #10---(30-12-3:6)
            '49-56.5-400',                     #11---(12-0)(23-3-2)
            '49-56.5-500',                     #12---(31-0)(13-4-2)
            '47-56.0-400']                     #       捉崩盘价
...
def init():
    ...
    with codecs.open(theUrl, 'r','utf-8') as f:
        ...
        for line in theList:
            ...
            if int(subList[7]) ==1:
                hostDict[subList[4]] =[subList[0] ,subList[1] ,subList[2] ,priceStage[0] ,priceStage[int(subList[5])] ,subList[6] ,subList[7]]
            else:
                hostDict[subList[4]] =[subList[0] ,subList[1] ,subList[2] ,priceStage[0] ,priceStage[int(subList[5])] ,priceStage[int(subList[6])] ,subList[7]]
            purl ='static/codePic'
