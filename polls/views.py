...
###51预测45+1000，则必然快板！则将介于今年2月和6月之间
priceStage1=['33-40.0-400',                     #0
            '45-55.4-1000',                    #1----
            '45-55.7-1000',                    #2----
            #参考2,9
            '48-56.5-400',                     #3----2
...
###51预测48+600，则比较复杂，估计介于6月与8月之间
priceStage=['33-40.0-400',                     #0
            #参考7、8(57/58)
            '45-55.3-900',                     #1!---(20-0)(13-1-1)
            '45-55.5-900',                     #2----(15-0)(19-0)(9-1-1)
            #参考7、8(58/59)
            '45-55.5-1000',                    #3!---(6-0)(23-0)(3-1-3)
            '45-55.7-1000',                    #4!---(11-0)(21-1-3)
            #策略3
            '48-55.5-1000',                    #5----(27-10-3-0::3)
            '48-55.7-1000',                    #6----(26-11-3-0::4)
            #参考6(58/59)
            '48-56.7-700',                     #7!---(17-0)(22-0)(8-0)(16-0)(1-1-2:0)
            '48-57.0-700',                     #8!---(14-0)(7-0)(5-0)(24-0)(2-4-2:0)
            '48-57.2-700',                     #9!---(12-0)(18-0)(25-2-2:0)(10-3-2:0)
            #参考9(58/59)
            '49-57.3-500',                     #10---(4-0)(28-0)
            '49-57.5-500',                     #11---(29-0)(30-0)
            '49-56.5-400']                     #
