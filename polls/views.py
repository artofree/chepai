...
priceStage=['33-40.0-400',                     #0
            '45-55.0-900',                     #1----(-0)(-2)
            '45-55.3-900',                     #2----(-0)(-1)
            '45-55.0-1000',                    #3----(-0)(-0)(-2)
            '45-55.5-1000',                    #4----(-0)(-0)(-1)
            '45-55.7-1000',                    #5----(-0)(-0)(-3)
            '48-56.5-700',                     #6----(-0)(-0)(-0)(-2-2:1)
            '48-56.7-700',                     #7----(-0)(-0)(-4-2:1)
            '48-55.5-1000',                    #8----(-10-3::4)
            '48-55.7-1000',                    #9----(-11-3::5)
            '49-56.7-400',                     #10---(-0)(-0)(-0)(-0)(-4-2:1)(-3-2:2)
            '49-56.5-500',                     #11---(-0)(-0)(-0)(-5-2:3)
            '49-56.7-500',                     #12---(-0)(-0)(-5-2:3)
            '49-56.5-400']                     #
