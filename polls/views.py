...
priceStage=['33-40.0-400',                     #0
            ...
            '45-56.2-700',                     #3----(17-0)
            '45-56.6-700',                     #4----(18-0)
            '45-56.2-800',                     #5!---(5-0)(19-0)
            '45-56.6-800',                     #6!---(2-0)(11-0)
            '45-56.3-900',                     #7----(28-0)(30-0)
            '45-56.6-900',                     #8!---(4-0)(13-0)
            '48-56.3-600',                     #9!---(29-0)(23-2-2:3)
            '48-56.6-600',                     #10---(7-0)
            '48-56.2-700',                     #11---(8-0)
            '48-56.6-700',                     #12!!-(9-0)(12-0)(15-0)
            '49-56.5-500',                     #13---(25-0)(26-2-2:1)
            '50-56.5-500',                     #14---(14-0)(27-1-2:3)
            '49-56.2-600',                     #15!--(6-0)(3-2-2:0)
            '49-56.6-600',                     #16---(22-0)
            '49-56.2-700',                     #17---(21-0)(10-0)
            '49-56.6-700',                     #18!!-(1-0)(20-0)
            '47-56.0-400']                     #       捉崩盘价
