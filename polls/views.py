...
###########################################################
priceStage=[['39-45-500' ,'48-55-500'],
            ['39-45-500' ,'48-55.5-800'],   #1呆     我打
            ['39-45-500' ,'48-55.5-500'],   #2呆     单打(rd06)
            ['39-45-500' ,'48-55-700'],     #3舅     3打
            ['39-45-500' ,'48-56-900'],     #4发     3打
            ['39-45-500' ,'48-55.5-500'],   #5约     双打(rd07)
            ['39-45-500' ,'48-55-700'],     #6约     3打
            ['39-45-500' ,'48-55.5-800'],   #7约     廖打
            ['39-45-500' ,'48-56-900']]     #8约     3打
curVersion =0
expPhotoList = []
drillList =[]
