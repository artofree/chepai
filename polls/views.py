...
priceStage=['33-40.0-400',                     #0
            '45-54.5-1000',                    #1----(-0)(-0)(-0-1-2)(-0-1-2)(-0-1-2)
            '45-55.0-1000',                    #2!---(-0)(-0)(-0)(-0-1-1)(-0-1-1)(-0-1-1)(-0-4-0)
            '45-55.5-1000',                    #3!---(-0)(-0)(-0)(-0-1-3)(-0-1-3)(-0-4-0)
            '45-55.8-1000',                    #4----(-0)(-0-1-3)
            '45-54.5-1100',                    #5----(-0)
            '45-55.0-1100',                    #6----(-0)(-0-1-1)
            '45-55.5-1100',                    #7!---(-0)(-0-1-3)(-0-4-0)
            '48-55.0-1000',                    #8----(-11-3-0::2)
            '48-55.5-1000',                    #9----(-13-3-0::3)
            '48-55.8-1000',                    #10---(-14-3-0::4)
            '49-56.7-400',                     #11---(-1-2:0)
            '49-57.5-400',                     #12---(-2-2:1)
            '49-56.7-500',                     #13---(-3-2:3)
            '49-57.5-500',                     #14---(-4-2:0)
            '49-56.5-400']                     #
